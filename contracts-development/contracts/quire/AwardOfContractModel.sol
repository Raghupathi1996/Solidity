...
contract AwardOfContractModel is AwardOfContractStructs {
    ...
    validAocListIndex(_index) 
    returns(uint) {
        return List.getPropUint(KEY, aocList, _index, propKeyAocContractAwardValue);
    }
    ...
    function setAocCavTender(uint256 _index, uint _value) public 
    onlyAocManager
    validAocListIndex(_index) 
    {
        List.setPropUint(KEY, aocList, _index, propKeyAocContractAwardValue, _value);
    }
