...
contract BankGuaranteeInvokeModel is BankGuaranteeInvokeStructs {
    ...
    constructor(
        ...
        address _bankGuaranteeReleaseModel
    ){
    ...
    string constant internal KEY = "BANK_GUARANTEE_INVOKE_MANAGER";
    ...
    modifier onlyBankGuaranteeReleaseManager() {
        require(msg.sender==quireContracts.getRegisteredContract("BANK_GUARANTEE_RELEASE_MANAGER"), "Unauthorized Contract Call");
        _;
    }
    ...
    /** @dev Setting the Bank Guarantee Invokes against the Bank Gid, Setting the Bank Guarantee Invokes against the EgpSystem Id , Setting the Bank Guarantee Invokes against the Bank Guarantee Reference Number and Bank Gid, Setting the Bank Guarantee Invokes against the Payment Advice Reference Number and Bank Gid.
      ...
      */
    function setBankGuaranteeInvokeIndices(BankGuaranteeInvoke memory _BankGuaranteeInvoke, uint256 _value, string memory _referenceNumber) public 
    onlyBankGuaranteeReleaseManager
    {
        ...
        bankGuaranteeReleaseModel.setBgReleaseAndInvokeListByBgUid(_bgInvokePaRefBankGid, _value, 1);  
