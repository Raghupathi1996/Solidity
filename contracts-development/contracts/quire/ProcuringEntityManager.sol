...
contract ProcuringEntityManager is ProcuringEntityStructs {
    ...
    returns(ProcuringEntity [] memory peList_, uint fromIncluded_, uint length_) {
        (peList_,fromIncluded_, length_) = procuringEntityModel.getAllProcuringEntities(_toExcluded, _count);
    }
