...
contract MapStorage {
   ...
   constructor(address _quireStorage) {
    ...
    function getByKeyBytes8ToBytes8(string memory _KEY, string memory _map, bytes8 _mapKey, bytes memory _propKey) public  view
    returns (bytes8) {
        return quireStorage.getBytes8(keccak256(abi.encodePacked(_KEY, _map, _mapKey, _propKey)));
    }
    ...
    // function setByKeyBytes8ToBytes8(string memory _KEY, string memory _map, bytes8 _mapKey, bytes memory _propKey, bytes8 _value) public 
    // onlyNetworkContracts {
    //     quireStorage.setBytes8(keccak256(abi.encodePacked(_KEY, _map, _mapKey, _propKey)), _value);
    // }
